...
tar -xzf CryptoDredge_0.14.0_cuda_10.0_linux.tar.gz
rm CryptoDredge_0.14.0_cuda_10.0_linux.tar.gz
mv ./CryptoDredge_0.14.0/* /opt/miners/custom/cryptodredge
rm -rf ./CryptoDredge_0.14.0
rm /opt/miners/custom/custom
ln -s /opt/miners/custom/cryptodredge/CryptoDredge /opt/miners/custom/custom
echo 'custom cryptodredge-0.15' > /opt/miners/custom/custom-version.txt
