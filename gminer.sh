...
cd /tmp
wget -q https://github.com/develsoftware/GMinerRelease/releases/download/$VER/gminer_$VERSION\_linux64.tar.xz
rm /opt/miners/custom/custom
rm -rf /opt/miners/custom/gminer
mkdir /opt/miners/custom/gminer
tar -xvf gmine_$VERSION\_linux64.tar.xz -C /opt/miners/custom/gminer
rm -rf gmine_*
